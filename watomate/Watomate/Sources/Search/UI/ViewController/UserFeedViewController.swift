...
extension UserFeedViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = UserTodoViewController(viewModel: UserTodoViewModel(userInfo: TodoUserInfo(userCellViewModel: viewModel.viewModel(at: indexPath))), followViewModel: FollowViewModel(followUseCase: FollowUseCase(followRepository: FollowRepository())))
